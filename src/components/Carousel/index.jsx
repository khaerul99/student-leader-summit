        ...
        <div className="carousel-item">
          <div className="card w-80 bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <div className="overflow-hidden overflow-y-auto h-[200px] hide-scrollbar">
                <p>
                  seru banget ga expect kalo ternyata seseruu ituuu, nonton reza
                  darmawangsa bisa deket banget, yang paling seru hp gue di
                  ambil reza🫶🏻🫶🏻
                </p>
              </div>
            </div>
        ...
        <div className="carousel-item">
          <div className="card w-80 bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <div className="overflow-hidden overflow-y-auto h-[200px] hide-scrollbar">
                <p>
                  acara yang sangat edukatif dan penuh inspirasi. Ditambah lagi,
                  ada pembicara yang sangat menginspirasi, serta mini konser
                  yang seru banget! 🎉😄
                </p>
              </div>
            </div>
            ...
            <div className="card-body">
              ...
              <div className="overflow-hidden overflow-y-auto h-[200px] hide-scrollbar">
                <p>
                  ...
                  🤭. Waktu nyanyi-nyanyi gitu aku dapet temen baru nih, karena
                  semuanya ikut excited 😆. Ngga salah lagi, ikut WJSLS pasti
                  bakal nambah relasi karena dihadiri oleh pelajar se-Jawa
                  Barat! Selain menyaksikan penampilan yang keren-keren, EJSLS
        ...
        <div className="carousel-item">
          <div className="card w-80 bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <div className="overflow-hidden overflow-y-auto h-[200px] hide-scrollbar">
                <p>
                  Menurut saya, EJSLS merupakan event khusus pelajar Jawa
                  Timur yang menyenangkan dan bukan kegiatan yang biasa, karena
                  di dalam acaranya banyak sekali kegiatan dari mulai talkshow
                  yang dihadiri oleh pembicara hebat sampai dengan mini konser
                  yang membuat para peserta semakin happy.
                </p>
              </div>
            </div>
          </div>
